...
window.addEventListener("load", function () {
    // Get the congrats message and button elements
    const congratsContainer = document.getElementById('congrats-container');
    const homeButton = document.getElementById('home-button');
    
    // Display the congrats message after the animation starts
    congratsContainer.style.display = 'block'; // Make sure it's visible when needed
    
    // Event listener for "Return Home" button to redirect
